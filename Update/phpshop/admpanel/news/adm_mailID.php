...
$TitlePage = __('Редактирование e-mail #' . $_GET['id']);
...
function actionStart() {
    ...
    $PHPShopGUI->setActionPanel(__("E-mail рассылки") . ' / ' . $data['mail'], array('Удалить'), array('Сохранить', 'Сохранить и закрыть'));


    // Содержание закладки 1
    $Tab1 = $PHPShopGUI->setField("E-mail", $PHPShopGUI->setInput('text.required', "mail_new", $data['mail'],false,'200'));

    ...
    <body id="form-signin">
        ...
        <div class="container">
            ...
            <form class="form-signin"  method="post" action="./">
                ...
                <h3 class="form-signin-heading hidden-xs">Авторизация<a class="pull-right hidden-xs" href="../../" title="Вернуться на сайт"><span class="glyphicon glyphicon-home"></span></a></h3>

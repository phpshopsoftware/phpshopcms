    ...
    <body style="background-color: #d8eafe; color: #555557; font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0px; padding: 0px;">
        <div style="background-color: #d8eafe; color: #555557; font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0px; padding: 0px;">
            ...
            <div class="bodmarg" style="padding-top:60px; padding-bottom:60px;">
                ...
                <table width="650" align="center" class="bg2 maint" border="0" cellspacing="0" cellpadding="0" style="background: #fff;">
                    <tr>
                        <td valign="top"><div id="pad1" style="color: #020202; font-size: 14px; padding: 0px 21px 20px;">
                                ...
                                <h2 style="color: #007bcc; font-size: 22px; font-weight: normal; margin: 0px 0px 0px 0px; padding: 10px 0px 14px 0px;">У Вас есть 1 месяц льготного продления техподдержки</h2>

                                <h3>Уважаемый пользователь!</h3>
                                <p>Через @day@ дней закончится техническая поддержка Вашего интернет-магазина по домену <a href="http://@url@" target="_blank">@url@</a>. 
                                </p>
                                <p>В течение 1 месяца для Вас действует <b>льготный тариф на техподдержку</b>, чтобы Вы смогли своевременно получать все обновления и технические консультации в течение целого года: 
                                </p>

                                <table class="table table-bordered" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody><tr>
                                            <th class="t5">Enterprise</th>
                                            <th class="t7">Pro 1C</th>
                                        </tr>
                                        <tr>
                                            <td class="t6">7 495 / <b>4 497</b> руб.</td>
                                            <td class="t8">12 495 / <b>7 497</b> руб.</td>
                                        </tr>
                                    </tbody></table>

                                <p>Посмотрите <a href="http://phpshop.ru/docs/update.html">журнал обновлений</a>, и убедитесь, что PHPShop постоянно развивается, становясь лучше с каждым годом.
                                <hr>
                                Все вопросы можно задать нам в чате, либо по телефону горячей линии 8-800-700-11-15, звонок бесплатный по России. 
                                ...
                                <td valign="top" class="bg1 bg2no" width="200" style="background: #f6f4f4;"><table width="100%" id="soc_t" border="0" cellspacing="0" cellpadding="0" style="margin-top: 30px;">
                                        <tr>
                                            <td width="54" align="center"><a href="https://www.facebook.com/shopsoft" style="color: #195c9c; font-size: 12px;" target="_blank"><img src="http://phpshop.ru/phpshop/templates/phpshop.ru/images/ico_f.gif" alt="Дружите с нами на Facebook" width="26" height="26" vspace="15" border="0" style="display: block;" title="Дружите с нами на Facebook"></a></td>
                                    ...
                                    <div align="center"><a href="http://phpshop.ru/" target="_blank"><img src="http://phpshop.ru/phpshop/templates/phpshop.ru/images/ico_php.gif" alt="logo PHPShop Software" width="148" height="155" border="0" style="display: block;" title="PHPShop Software"></a></div></td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td width="50%" valign="top">
                                        ...
                                        <div style="font-size:12px; color:#555557;padding-left:20px; padding-bottom:32px; padding-right:20px;" class="inopad">
                                            Чтобы получать бонусы, Вам нужно порекомендовать использовать PHPShop своим друзьям, коллегам, знакомым. Предложите ввести им Ваш френдо-код при регистрации, и мы подарим 500 руб. на их бонусный счет. Вам же будут переходить 10% от всех оплат лицензий Ваших друзей.
                                        </div>

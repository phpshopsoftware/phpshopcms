...
function actionStart() {
    ...
    $PHPShopInterface->setCaption(array("Поисковая фраза, Поисковая система", "40%"), array("Визиты", "10%"), array("Посетители", "10%"), array("Отказы", "10%"), array("Глубина", "10%"), array("Время", "10%", array('align' => 'left')));

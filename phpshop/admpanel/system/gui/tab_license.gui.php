...
<div id="license">
    ...
    <p>3.<b> Условия использования продукта и ограничения </b>
       ...
       <br>3.5. Лицензия без копирайтов Автора оплачивается согласно тарифам, представленным на <a href="http://www.phpshop.ru/order/?from='.$_SERVER['SERVER_NAME'].'&path=copyright" target="_blank">сайте Автора</a>. 
